 ...
 *
 */
class Custom_Captcha_SimpleCaptcha {
    ...
    public function __construct($config = array()) {
    	$this->auth		=	new Zend_Session_Namespace("Zend_Security");
    }
    ...
    function GetDictionaryCaptchaText($extended = false) {
        ...
        $fp     = fopen(realpath(APPLICATION_PATH."/../library/Custom/Captcha").$wordsfile, "r");
        $length = strlen(fgets($fp));
        if (!$length) {
            return false;
        }
        $line   = rand(1, (filesize(realpath(APPLICATION_PATH."/../library/Custom/Captcha").$wordsfile)/$length)-2);
    ...
    protected function WriteText($text, $fontcfg = array()) {
        ...
        $fontfile = realpath(APPLICATION_PATH."/../library/Custom/Captcha").$this->resourcesPath.'/fonts/'.$fontcfg['font'];
