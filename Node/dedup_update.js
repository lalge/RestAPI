...
// Selection Process
var batchid = "20180616";
var dt_id = new mongodb.ObjectID('59a90d4613c9c1dc09004ed0');
var include_sources = [];
...
//              for same DT
                var keywordmatch;
                for (i = 0; i < entity_data.dt[0].keyword_match.length; i++) {
                    keywordmatch += "'source_dt.$.keyword_matched':" + entity_data.dt[0].keyword_match[i] + ",";
                }
                ...
                updatedt = {
                    $addToSet: {
                        ...
                        'source_dt.$.keyword_matched': {$each: entity_data.dt[0].keyword_match},
    ...
    addEntity: function (entity_data, addEntity_callback) {
        ...
        var data = {
            ...
            'source_dt': [{
                    ...
                    'keyword_matched': entity_data.dt[0].keyword_match,
                    'source': [
                        source_id
                    ],
                    'company_in_queue': 2,
